# -*- coding: utf-8 -*-
"""
GEE export: годовые признаки 2003-2009 для расширения временного ряда (P2).
...
YEARS = list(range(2003, 2024))  # 2003..2024 включительно
SOUTH, NORTH = 55, 78
...
print(f'Годы: {YEARS}  ({len(YEARS)} лет)')
